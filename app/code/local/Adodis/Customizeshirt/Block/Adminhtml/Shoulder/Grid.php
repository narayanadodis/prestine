...
class Adodis_Customizeshirt_Block_Adminhtml_Shoulder_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('shoulderGrid');
      $this->setDefaultSort('shoulder_id');
  ...
  {
      $this->addColumn('shoulder_id', array(
      ...
      $this->addColumn('shoulder_title', array(
          'header'    => Mage::helper('customizeshirt')->__('Title'),
          'align'     =>'left',
          'index'     => 'shoulder_title',
      ));
	  
	  $this->addColumn('shoulder_image', array(
            'header'    => Mage::helper('customizeshirt')->__('Image'),
            'align'     => 'center',
            'width'     => '300px',
            'index'     => 'shoulder_image',
            'type'      => 'image',
            'escape'    => true,
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => 'customizeshirt/adminhtml_shoulder_grid_renderer_image',
        ));
    ...
    {
        $this->setMassactionIdField('shoulder_id');
        $this->getMassactionBlock()->setFormFieldName('shoulder');
