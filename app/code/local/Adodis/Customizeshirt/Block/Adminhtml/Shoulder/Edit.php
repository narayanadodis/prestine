...
class Adodis_Customizeshirt_Block_Adminhtml_Shoulder_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_shoulder';
    ...
    {
        if( Mage::registry('shoulder_data') && Mage::registry('shoulder_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('shoulder_data')->getTitle()));
        } else {
