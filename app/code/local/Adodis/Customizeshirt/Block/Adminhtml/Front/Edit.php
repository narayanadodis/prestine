...
class Adodis_Customizeshirt_Block_Adminhtml_Front_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('front_data') && Mage::registry('front_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('front_data')->getTitle()));
        } else {
