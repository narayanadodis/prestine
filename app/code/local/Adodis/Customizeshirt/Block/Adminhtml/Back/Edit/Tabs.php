...
class Adodis_Customizeshirt_Block_Adminhtml_Back_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
      $this->addTab('form_section', array(
          ...
          'content'   => $this->getLayout()->createBlock('customizeshirt/adminhtml_back_edit_tab_form')->toHtml(),
      ));
