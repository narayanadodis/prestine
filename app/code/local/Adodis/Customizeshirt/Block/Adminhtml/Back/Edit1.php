...
class Adodis_Customizeshirt_Block_Adminhtml_Back_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateBack('save', 'label', Mage::helper('customizeshirt')->__('Save Item'));
        $this->_updateBack('delete', 'label', Mage::helper('customizeshirt')->__('Delete Item'));
		
        $this->_addBack('saveandcontinue', array(
