...
class Adodis_Customizeshirt_Block_Adminhtml_Customizeshirt_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('customizeshirtGrid');
      $this->setDefaultSort('customizeshirt_id');
  ...
  {
      $collection = Mage::getModel('customizeshirt/customizeshirt')->getCollection();
  ...
  {
      $this->addColumn('customizeshirt_id', array(
          'header'    => Mage::helper('customizeshirt')->__('ID'),
          'align'     =>'right',
          'width'     => '50px',
          'index'     => 'customizeshirt_id',
      ));
    ...
    {
        $this->setMassactionIdField('customizeshirt_id');
        $this->getMassactionBlock()->setFormFieldName('customizeshirt');
