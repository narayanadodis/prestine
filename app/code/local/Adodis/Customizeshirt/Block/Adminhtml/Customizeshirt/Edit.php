...
class Adodis_Customizeshirt_Block_Adminhtml_Customizeshirt_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_customizeshirt';
    ...
    {
        if( Mage::registry('customizeshirt_data') && Mage::registry('customizeshirt_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('customizeshirt_data')->getTitle()));
        } else {
