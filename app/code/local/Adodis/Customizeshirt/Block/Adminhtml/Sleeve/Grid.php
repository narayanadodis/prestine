...
class Adodis_Customizeshirt_Block_Adminhtml_Sleeve_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	public function __construct()
	{
		parent::__construct();
	    $this->setId('sleeveGrid');
	    $this->setDefaultSort('sleeve_id');
	...
	protected function _prepareCollection()
	{
	 ...
	 {
	 	$this->addColumn('collar_id', array(
      	...
      	$this->addColumn('sleeve_title', array(
          'header'    => Mage::helper('customizeshirt')->__('Title'),
          'align'     =>'left',
          'index'     => 'sleeve_title',
      	));

      	$this->addColumn('sleeve_image', array(
            ...
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => 'customizeshirt/adminhtml_sleeve_grid_renderer_image',
        ));
	 ...
	 {
	 	$this->setMassactionIdField('sleeve_id');
	 	$this->getMassactionBlock()->setFormFieldName('sleeve');
