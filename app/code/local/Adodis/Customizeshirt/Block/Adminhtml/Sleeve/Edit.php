...
class Adodis_Customizeshirt_Block_Adminhtml_Sleeve_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if( Mage::registry('sleeve_data') && Mage::registry('sleeve_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('sleeve_data')->getTitle()));
        } else {
