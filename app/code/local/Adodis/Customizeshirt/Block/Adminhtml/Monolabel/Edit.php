...
class Adodis_Customizeshirt_Block_Adminhtml_Monolabel_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_monolabel';
    ...
    {
        if( Mage::registry('monolabel_data') && Mage::registry('monolabel_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('monolabel_data')->getTitle()));
        } else {
