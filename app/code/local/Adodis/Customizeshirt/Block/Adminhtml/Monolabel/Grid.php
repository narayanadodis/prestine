...
class Adodis_Customizeshirt_Block_Adminhtml_Monolabel_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('monolabelGrid');
      $this->setDefaultSort('monolabel_id');
  ...
  {
      $collection = Mage::getModel('customizeshirt/monolabel')->getCollection();
  ...
  {
      $this->addColumn('monolabel_id', array(
      ...
      $this->addColumn('monolabel_title', array(
          'header'    => Mage::helper('customizeshirt')->__('Title'),
          'align'     =>'left',
          'index'     => 'monolabel_title',
      ));
	  ...
	  $this->addColumn('monolabel_image', array(
            'header'    => Mage::helper('customizeshirt')->__('Image'),
            'align'     => 'center',
            'width'     => '300px',
            'index'     => 'monolabel_image',
            'type'      => 'image',
            'escape'    => true,
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => 'customizeshirt/adminhtml_monolabel_grid_renderer_image',
        ));
    ...
    {
        $this->setMassactionIdField('monolabel_id');
        $this->getMassactionBlock()->setFormFieldName('monolabel');
