...
class Adodis_Customizeshirt_Block_Adminhtml_Collar_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if( Mage::registry('collar_data') && Mage::registry('collar_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('collar_data')->getTitle()));
        } else {
