...
class Adodis_Customizeshirt_Block_Adminhtml_Collar_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('collarGrid');
      $this->setDefaultSort('collar_id');
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('collar_title', array(
          'header'    => Mage::helper('customizeshirt')->__('Title'),
          'align'     =>'left',
          'index'     => 'collar_title',
      ));
	  
	  $this->addColumn('collar_image', array(
            ...
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => 'customizeshirt/adminhtml_collar_grid_renderer_image',
        ));
    ...
    {
        $this->setMassactionIdField('collar_id');
        $this->getMassactionBlock()->setFormFieldName('collar');
