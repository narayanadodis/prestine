...
class Adodis_Customizeshirt_Block_Adminhtml_Pocket_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if( Mage::registry('pocket_data') && Mage::registry('pocket_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('pocket_data')->getTitle()));
        } else {
