...
class Adodis_Customizeshirt_Block_Adminhtml_Pocket_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('pocketGrid');
      $this->setDefaultSort('pocket_id');
  ...
  {
      $this->addColumn('pocket_id', array(
      ...
      $this->addColumn('pocket_title', array(
          'header'    => Mage::helper('customizeshirt')->__('Title'),
          'align'     =>'left',
          'index'     => 'pocket_title',
      ));
	  
	  $this->addColumn('pocket_image', array(
            ...
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => 'customizeshirt/adminhtml_pocket_grid_renderer_image',
        ));
    ...
    {
        $this->setMassactionIdField('pocket_id');
        $this->getMassactionBlock()->setFormFieldName('pocket');
