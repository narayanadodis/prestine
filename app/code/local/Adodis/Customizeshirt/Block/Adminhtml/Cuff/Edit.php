...
class Adodis_Customizeshirt_Block_Adminhtml_Cuff_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        if( Mage::registry('cuff_data') && Mage::registry('cuff_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('cuff_data')->getTitle()));
        } else {
