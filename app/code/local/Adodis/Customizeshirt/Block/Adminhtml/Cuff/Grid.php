...
class Adodis_Customizeshirt_Block_Adminhtml_Cuff_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('cuffGrid');
      $this->setDefaultSort('cuff_id');
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('cuff_title', array(
          'header'    => Mage::helper('customizeshirt')->__('Title'),
          'align'     =>'left',
          'index'     => 'cuff_title',
      ));
	  
	  $this->addColumn('cuff_image', array(
            ...
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => 'customizeshirt/adminhtml_cuff_grid_renderer_image',
        ));
    ...
    {
        $this->setMassactionIdField('cuff_id');
        $this->getMassactionBlock()->setFormFieldName('cuff');
