...
class Adodis_Customizeshirt_Block_Adminhtml_Embroidery_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_embroidery';
    ...
    {
        if( Mage::registry('embroidery_data') && Mage::registry('embroidery_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('embroidery_data')->getTitle()));
        } else {
