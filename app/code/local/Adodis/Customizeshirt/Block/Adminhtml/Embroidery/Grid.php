...
class Adodis_Customizeshirt_Block_Adminhtml_Embroidery_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('embroideryGrid');
      $this->setDefaultSort('embroidery_id');
  ...
  {
      $collection = Mage::getModel('customizeshirt/embroidery')->getCollection();
  ...
  {
      $this->addColumn('embroidery_id', array(
      ...
      $this->addColumn('embroidery_title', array(
	  ...
	  $this->addColumn('embroidery_image', array(
            ...
            'align'     => 'center',
            'width'     => '300px',
            'index'     => 'embroidery_image',
            'type'      => 'image',
            'escape'    => true,
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => 'customizeshirt/adminhtml_embroidery_grid_renderer_image',
        ));
    ...
    {
        $this->setMassactionIdField('embroidery_id');
        $this->getMassactionBlock()->setFormFieldName('embroidery');
