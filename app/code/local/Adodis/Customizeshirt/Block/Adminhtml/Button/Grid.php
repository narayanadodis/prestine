...
class Adodis_Customizeshirt_Block_Adminhtml_Button_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('buttonGrid');
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('button_title', array(
          'header'    => Mage::helper('customizeshirt')->__('Title'),
          'align'     =>'left',
          'index'     => 'button_title',
      ));
	  
      $this->addColumn('button_color', array(
          'header'    => Mage::helper('customizeshirt')->__('Button Color'),
          'align'     =>'left',
          'index'     => 'button_color',
      ));

      $this->addColumn('button_thread_color', array(
          'header'    => Mage::helper('customizeshirt')->__('Button Thread Color'),
          'align'     =>'left',
          'index'     => 'button_thread_color',
      ));

	  /*$this->addColumn('button_image', array(
            ...
            'sortable'  => false,
            'filter'    => false,
            'renderer'  => 'customizeshirt/adminhtml_button_grid_renderer_image',
        ));
    ...
    {
        $this->setMassactionIdField('button_id');
        $this->getMassactionBlock()->setFormFieldName('button');
