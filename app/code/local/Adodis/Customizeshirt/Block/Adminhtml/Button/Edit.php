...
class Adodis_Customizeshirt_Block_Adminhtml_Button_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('button_data') && Mage::registry('button_data')->getId() ) {
            return Mage::helper('customizeshirt')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('button_data')->getTitle()));
        } else {
